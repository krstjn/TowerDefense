...
var g_waves = [
    ...
    [
        ...
        {type: SUPERMAN, amount: 3, initialDelay: 500, bounty: 30, hp: 10},
    ...
    [
        ...
        {type: SUPERMAN, amount: 5, initialDelay: 650, bounty: 30, hp: 10},
...
for (var i=2; i<=50; i++) {
    ...
    g_waves.push(
        [
            ...
            {type: MOOSE, amount: 10, initialDelay: 275, bounty: 20*i, hp: 6*i*_multip},
            {type: DOG, amount: 10, initialDelay: 500, bounty: 20*i, hp: 3*i*_multip}
        ],
        [
            {type: SUPERMAN, amount: 10, initialDelay: 0, bounty: 30*i, hp: 10*i*_multip},
        ...
        [
            ...
            {type: SUPERMAN, amount: 5, initialDelay: 275, bounty: 30*i, hp: 10*i*_multip},
            {type: DOG, amount: 10, initialDelay: 500, bounty: 20*i, hp: 3*i*_multip}
        ],
        [
            ...
            {type: SUPERMAN, amount: 20, initialDelay: 1500, bounty: 30*i, hp: 10*i*_multip}
        ],
        [
            ...
            {type: SUPERMAN, amount: 3, initialDelay: 1500, bounty: 30*5*i, hp: 10*10*i*_multip}
        ]
    );
};
